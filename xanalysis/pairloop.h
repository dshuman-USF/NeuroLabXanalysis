...
void pair_loop (Edt *edt);
void pair_status (Edt *edt, int threshold);
void pair_count (Edt *edt);
void pair_time (Edt *edt);
void pair_plot (Edt *edt, int refidx, int taridx, int spcnt);
void pair_bump (Edt *edt, int refidx, int taridx);
void init_pair (Pair *p, int refidx, int taridx, int bc, bool read);
bool read_pair (Pair *p, bool all);
void threshold (Edt *edt);
